...
export function getAppointmentsByPatient(patient, cb = null) {
  return (dispatch) => {
    return api
      .getData("appointmentsByPatient/" + patient)
      .then((response) => {
...
export function getAppointmentsByPatientAndDate(patient, date, cb = null) {
  return (dispatch) => {
    return api
      .getData("appointmentsByPatientAndDate" + "/" + patient + "/" + date)
      .then((response) => {
...
export function saveAppointment(appointment, cb = null) {
  return (dispatch) => {
    if (appointment._id) {
      return api
        .putData(modelPoint + "/" + appointment._id, appointment)
        .then((response) => {
      ...
      return api
        .postData(modelPoint, appointment)
        .then((response) => {

...
export function saveDetectedDisease(detectedDisease, cb = null) {
  return (dispatch) => {
    if (detectedDisease._id) {
      return api
        .putData(modelPoint + "/" + detectedDisease._id, detectedDisease)
        .then((response) => {
      ...
      return api
        .postData(modelPoint, detectedDisease)
        .then((response) => {
...
export function deleteDetectedDisease(detectedDisease, cb) {
  return (dispatch) => {
    return api
      .deleteData(modelPoint + "/" + detectedDisease._id)
      .then((response) => {
...
export function getDetectedDisease(id, cb = null) {
  return (dispatch) => {
    if (id) {
      ...
      dispatch(selectDetectedDisease(new DetectedDisease()));
